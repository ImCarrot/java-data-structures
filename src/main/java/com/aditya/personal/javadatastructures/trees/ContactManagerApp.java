...
public class ContactManagerApp {
    ...
    public void searchContacts() {
        ...
        System.out.println(contacts.contains(new Contact("Fay", "Moro", null)) != null); // should be true
        System.out.println(contacts.contains(new Contact("Bob", "Hope", null)) != null); // should be false
    }
